      ...
      body: Stack(
        children: [
          ...
          Positioned(
            top: 131.h,
            left: 23.w,
            child: Text('오늘의 상담 완료!', style: TextStyle(fontFamily: 'IBMPlexSansKR', fontSize: 40.sp, fontWeight: FontWeight.w200, color: Color(0xFF000000)),),),
            ...
            child: Center(
              child: Column(
                children: [
                  Stack(
                    children: [
                      Image.asset('assets/images/one_on_one/summary.png', width: 313.w,),
                      Positioned(
                        top: 60.h,
                        left: 0,
                        right: 0,
                  ...
                  Stack(
                    children: [
                      Image.asset('assets/images/one_on_one/reflection.png', width: 313.w,),
                      Positioned(
                        top: 60.h,
                        left: 0,
                        right: 0,
